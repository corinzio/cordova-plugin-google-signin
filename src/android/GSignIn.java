...
private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
                ...
                try {
                        obj.put(GSignIn.LOGIN_EMAIL, email);
                        obj.put(GSignIn.LOGIN_NAME, name);
                        obj.put(GSignIn.LOGIN_PHOTO, photourl);
                        obj.put(GSignIn.LOGIN_TOKENID, token);
                        obj.put(GSignIn.LOGIN_ID, id);
